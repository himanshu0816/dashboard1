...
export function Documents() {
  return (
    <>
      ...
      <div className='row g-6 g-xl-9 mb-6 mb-xl-9'>
        <div className='col-12 col-sm-12 col-xl'>
          <Screenshot icon='/media/svg/files/pdf.svg' title='Project Reqs..' description='3 days ago' />
        </div>
        <div className='col-12 col-sm-12 col-xl'>
          <Screenshot icon='/media/svg/files/doc.svg' title='CRM App Docs..' description='3 days ago' />
        </div>
        <div className='col-12 col-sm-12 col-xl'>
          <Screenshot
        ...
        <div className='col-12 col-sm-12 col-xl'>
          <Screenshot icon='/media/svg/files/ai.svg' title='Metronic Logo' description='5 days ago' />
        </div>
        <div className='col-12 col-sm-12 col-xl'>
          <Screenshot icon='/media/svg/files/sql.svg' title='Orders backup' description='1 week ago' />
        </div>
      </div>
