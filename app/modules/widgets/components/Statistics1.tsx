      ...
      {/* <div className='row g-5 g-xl-8'>
        <div className='col-xl-4'>
          <StatisticsWidget3
            ...
            color='success'
            title='Active Time'
            description='The Time in which you Working Actively'
            change='70%'
          />
        </div>
        ...
        <div className='col-xl-4'>
          <StatisticsWidget3
            ...
            color='danger'
            title='Ideal Time'
            description='The Time in which you did Nothing'
            change='30%'
          />
        </div>
        ...
        <div className='col-xl-4'>
          <StatisticsWidget3
            ...
            color='primary'
            title='Billable Time'
            description='Actual Counted Time'
            change='70%'
          />
          ...
          <StatisticsWidget3
            ...
            color='secondary'
            title='Toatl Time'
            description='Toatl Counted Time'
            change='100%'
          />
          </div>
        </div>
