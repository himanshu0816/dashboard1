  ...
  return (
    ...
    >
      ...
      <AsideMenuItemWithSub
        ...
        fontIcon='bi-app-indicator'
      >
        <AsideMenuItem to='/crafted/pages/profile/overview' title='Daily' hasBullet={true} />
      ...
      <AsideMenuItemWithSub
        ...
        fontIcon='bi-app-indicator'
      >
        <AsideMenuItem to='/crafted/pages/profile/overview' title='Screenshots' hasBullet={true} />
